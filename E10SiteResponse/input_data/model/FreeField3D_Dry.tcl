...
# KZ: adding recorder flag in config for this section
if {0} {
...
recorder Node -file acceleration.out -time  -node $nNodeT -dof 1 2 3 accel

# KZ: adding another flag in config 
if {0} {
	# record stress and strain at each gauss point in the soil elements
	if {$IsSSP} {
