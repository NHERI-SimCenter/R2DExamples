...
# 	recorder Drift -file $dataDir/Drift-Story2.out -time -iNode 12 -jNode 13 -dof 1 -perpDirn 2;
# 	recorder Drift -file $dataDir/Drift-Roof.out -time -iNode 11 -jNode 13 -dof 1 -perpDirn 2;
	
# # record floor displacements	
# 	recorder Node -file $dataDir/Disp.out -time -node 12 13 -dof 1 disp;
...
# 		region 4 -eleRange 111 222 -rayleigh 0.0 0.0 $a1_mod 0.0;	# assign stiffness proportional damping to frame beams & columns w/ n modifications
# 		region 5 -node 12 13 22 23 -rayleigh $a0 0.0 0.0 0.0;		# assign mass proportional damping to structure (assign to nodes with mass)
